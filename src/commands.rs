...
#[command]
pub async fn is_registered<R: Runtime>(
    app: AppHandle<R>,
    id: String,
) -> Result<bool> {
    let monitor = app.state::<MacOSInputMonitor>();
...
pub fn get_keycode_table() -> HashMap<String, Vec<i64>> {
    HashMap::from([
        ("F1".to_string(), vec![constants::KEY_F1, constants::KEY_F1_MEDIA]),
        ("F2".to_string(), vec![constants::KEY_F2, constants::KEY_F2_MEDIA]),
        ("F3".to_string(), vec![constants::KEY_F3, constants::KEY_F3_MEDIA]),
        ("F4".to_string(), vec![constants::KEY_F4, constants::KEY_F4_MEDIA]),
        ("F5".to_string(), vec![constants::KEY_F5, constants::KEY_F5_MEDIA]),
        ("F6".to_string(), vec![constants::KEY_F6, constants::KEY_F6_MEDIA]),
        ("F7".to_string(), vec![constants::KEY_F7, constants::KEY_F7_MEDIA]),
        ("F8".to_string(), vec![constants::KEY_F8, constants::KEY_F8_MEDIA]),
        ("F9".to_string(), vec![constants::KEY_F9, constants::KEY_F9_MEDIA]),
        ("F10".to_string(), vec![constants::KEY_F10, constants::KEY_F10_MEDIA]),
        ("F11".to_string(), vec![constants::KEY_F11, constants::KEY_F11_MEDIA]),
        ("F12".to_string(), vec![constants::KEY_F12, constants::KEY_F12_MEDIA]),
    ])
}
