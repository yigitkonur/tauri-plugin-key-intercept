...
impl EventTap {
    ...
    pub fn new<R: Runtime>(app_handle: AppHandle<R>) -> Result<Self, Error> {
        ...
        // CRITICAL: Use thread::Builder with explicit stack size for CGEventTap
        // This ensures the thread isn't prematurely killed by Launch Services
        std::thread::Builder::new()
            .name("CGEventTap-Monitor".to_string())
        ...
        .expect("Failed to spawn CGEventTap thread");
